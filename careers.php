<?php   
	...
	$filenameWithDirectory = "/tmp-upload".$name.".pdf";  //give path of tmp-uploads folder(available in this project folder) with slash(/ or \ as per your path) at end of path
	...
	{
		$status = mailfunction("aehteshaama@gmail.com", "Company", $body, $filenameWithDirectory); //reciever
        if($status)
