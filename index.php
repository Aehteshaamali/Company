...
<body>
    <header class="header">
        <a href="index.html#home" class="logo"><img src="./images/logo.png" alt="SparkQue Tech Solutions"></a>
  ...
  <section id="home" class="home">
      <h1>Welcome to SparkQue Tech Solutions</h1>
      <h2>An IT Service Company</h2>
  ...
  <section id="about" class="about">
    ...
    <div class="row">
        <div class="content">
            <h3>Our wish to accomplish you wish...</h3>
            <p class="lead center-text">Founded in <strong>2022</strong>, SparkQue Tech Solutions has been at the forefront of delivering cutting-edge IT services and career-transforming training programs.</p><br>
            <h1>Our Mission</h1>
            <p>To empower individuals and businesses by delivering innovative IT solutions and industry-ready training programs, bridging the gap between talent and technology with integrity, creativity, and excellence.</p><br>
            <h1>Our Vision</h1>
            <p>To be a global leader in IT services and technical education, fostering a community where technology empowers every dream and every learner becomes a leader.</p>
  ...
  <div class="pt-5 pb-5" style="background-color: #f2f2f2;">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 col-sm-6">
          <div class="item"> <span class="icon feature_box_col_three"><i class="fa fa-bar-chart"></i></span>
            <h6>Data Analysis</h6>
            <p>Our Data Analysis Services Involve Collecting, Cleaning, And Interpreting Data To Uncover Insights. From Business Intelligence To Predictive Modeling, We Help Organizations Make Data-Driven Decisions Efficiently.</p>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6">
          <div class="item"> <span class="icon feature_box_col_three"><i class="fa fa-handshake-o"></i></span>
            <h6>IT Consultancy</h6>
            <p>Our IT Consultancy Services Help Businesses Align Technology With Goals. From Strategic Planning To System Integration, We Offer Expert Guidance To Improve Efficiency And Drive Innovation.</p>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6">
          <div class="item"> <span class="icon feature_box_col_three"><i class="fa fa-graduation-cap"></i></span>
            <h6>Training & Internship Program</h6>
            <p>Our Training And Internship Program Provides Hands-On Experience With Real-World Projects. Designed For Students And Professionals, It Builds Skills In Development, Design, And Data Analytics.</p>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6">
          <div class="item"> <span class="icon feature_box_col_three"><i class="fa fa-paint-brush"></i></span>
            <h6>Graphic Design</h6>
            <p>Our Graphic Design Services Cover Branding, UI/UX, And Visual Content Creation. Whether It’s A Logo Or Full Marketing Kit, Our Designers Craft Visually Compelling Designs That Tell Your Story.</p>
          </div>
        </div>
      </div>
    </div>
...
<section class="team" style="margin-top: 7rem;">
  ...
  <div class="row">
      <div class="card">
          <div class="image">
              <img src="./images/anshul.jpeg" alt="Team member 1">
          </div>
          <div class="info">
              <h3>Anshul Gupt</h3>
              <span>Founder</span>
  ...
  <div class="row">
      <div class="card">
          <div class="image">
              <img src="./images/Aehteshaam.jpeg" alt="Team member 1">
          </div>
          <div class="info">
              <h3>Aehteshaam Ali</h3>
              <span>Co-Founder & CEO</span>
              <div class="icons">
                  <a href="https://www.instagram.com/mr_ali__sayyed" class="fab fa-instagram"></a>
                  <a href="https://www.linkedin.com/in/aehteshaam-ali-2016b315b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" class="fab fa-linkedin"></a>
              </div>
          </div>
      </div>
  </div>
  <div class="row">
      <div class="card">
          <div class="image">
              <img src="./images/vishakha.jpeg" alt="Team member 1">
          </div>
          <div class="info">
              <h3>Vishakha Makode </h3>
              <span>Director & HR Head</span>
              <div class="icons">
                  <a href="https://www.instagram.com/" class="fab fa-instagram"></a>
                  <a href="https://www.linkedin.com/" class="fab fa-linkedin"></a>
              </div>
  ...
  <div class="row">
      <div class="card">
          <div class="image">
              <img src="./images/gaurish.jpeg" alt="Team member 1">
          </div>
          <div class="info">
              <h3>Gaurish Rawat</h3>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-3 col-md-6 footer-contact" style="font-size: 1.5rem;">
                      ...
                      <p>
                          ...
                          Indore [M.P]<br>
                          India <br>
                          <strong>Phone:</strong> 7869109189<br>
                          <strong>Email:</strong> sparkquetechsol@gmail.com<br>
                      </p>
      ...
      <div class="container">
          <div class="row align-items-center">
              <div class="col-md-6 copyright" style="color: #fff; font-size: 1.3rem;">
                  Copyright &copy; 2022 IT Company Website. All Rights Reserved.
              </div>
          </div>
      </div>
  </div>
